package com.zjy.north.baidulocation;
...
public class BaiduLocation {
    ...
    //绑定签名SHA1
    public static final String AK = "F8mkTvS3fwOHftqGKi7dafUzL9Zo80G0";

    public BaiduLocation(Context m, onReceiveLocationListener mListener) {
        this.mListener = mListener;
        initLocationOption(m);
    }

    private void initLocationOption(Context mContext) {
    ...
    public interface onReceiveLocationListener {
        public void onReceiveLocation(Mlocation location);
    }
    ...
    public class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            mlocation.district = district;
            mlocation.street = street;
            mlocation.streetNumber = streetNumber;
            mlocation.cityCode = cityCode;
